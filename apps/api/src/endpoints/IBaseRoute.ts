...
import { DefaultInternalServerError, InternalServerError, IServiceError } from '@azure-burst-monitor/backend-errors';
...
abstract class IBaseRoute<TRequest extends IRequest, TResponse extends IResponse, TEnv extends IEnv> extends OpenAPIRoute {
  async handle(c: RouteContext<TEnv>) {
    try {
      const request: TRequest = { raw: c.req.raw } as TRequest;
